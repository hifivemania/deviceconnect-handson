...
まずベースになる[HTML/JavaScriptファイル（Zipで固めてあります）をダウンロード](https://github.com/hifivemania/hifive-deviceconnect-handson/raw/master/2.zip)します。ダウンロードしたらZipファイルを解凍してください。
...
hello.jsを含む今回のコードは[hifive-deviceconnect-handson/2 at master · hifivemania/hifive-deviceconnect-handson](https://github.com/hifivemania/hifive-deviceconnect-handson/tree/master/2)にて確認できます。また、[実際に動いているデモはこちらのURL](https://hifivemania.github.io/hifive-deviceconnect-handson/2/)にて確認できます。

## 今回はhifiveの基本を紹介しました。[次にDeviceConnectの基礎を学びます](./3.md)に入っていきます。
